            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="formJmlhZakat" class="block text-gray-700 text-sm font-bold mb-2">Jumlah Zakat</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formName" wire:model="zakat_amount">
                            @error('zakat_amount') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            <label for="formDeskZakat" class="block text-gray-700 text-sm font-bold mb-2">Deskripsi Zakat</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="formName" wire:model="zakat_desc">
                            @error('zakat_desc') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <select class="form-control" wire:model="status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                ...
                                <option value="1">Pembayaran Sudah Diverifikasi</option>
                                <option value="0">Pembayaran Sudah Belum Diverifikasi</option>
                            </select>
