...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <button wire:click="create()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Tambah Data Pembayaran</button>
            ...
            <table class="table-fixed w-full">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-4 py-2">Jumlah Zakat</th>
                        <th class="px-4 py-2">Deskripsi Zakat</th>
                ...
                <tbody>
                    @forelse($members as $row)
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $row->zakat_amount }}</td>
                            <td class="border px-4 py-2">{{ $row->zakat_desc }}</td>
